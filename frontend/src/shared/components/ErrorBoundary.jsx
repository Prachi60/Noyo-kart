        ...
        if (this.state.hasError) {
            return (
                <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-4 font-outfit">
                    <div className="max-w-md w-full bg-white rounded-3xl shadow-xl p-8 text-center border border-gray-100">
                        ...
                        <div className="space-y-3">
                            <button
                                ...
                                className="w-full bg-[#0284c7] hover:bg-[#0369a1] text-white font-semibold py-3 px-6 rounded-xl transition-all flex items-center justify-center gap-2 shadow-lg shadow-brand-100"
                            >
                    ...
                    <div className="mt-8 flex items-center gap-2 text-[#0284c7] font-semibold">
