        ...
        footer={
          <div className="flex gap-2 justify-end">
            ...
            <button
              ...
              onClick={handleSave}
              disabled={saving}
              className="px-4 py-2 rounded-xl text-sm font-bold bg-[#0284c7] text-white hover:opacity-90 disabled:opacity-50"
            >
              {saving ? "Saving…" : "Save"}
            </button>
          </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <button
                  ...
                  className="flex items-center gap-1 text-[10px] font-bold text-[#0284c7]"
                >
