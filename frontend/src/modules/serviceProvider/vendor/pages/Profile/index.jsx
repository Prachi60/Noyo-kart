...
const Profile = () => {
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      ...
      const storedVendorData = JSON.parse(localStorage.getItem('spVendorData') || '{}');
      ...
      try {
        ...
        if (response.success) {
          ...
          localStorage.setItem('spVendorData', JSON.stringify(vendorData));
        } else {
      ...
      <main className="px-4 pt-4 pb-6">
        ...
        >
          ...
          <div className="relative z-10">
            <div className="flex items-start gap-4">
              ...
              {/* Navigate Button */}
              <button
                onClick={() => navigate('/sp/vendor/profile/details')}
        ...
        <div className="px-4 mb-5">
          <div className="grid grid-cols-3 gap-3">
            {/* Active Jobs */}
            <button
              onClick={() => navigate('/sp/vendor/jobs')}
            ...
            {/* Wallet */}
            <button
              onClick={() => navigate('/sp/vendor/wallet')}
              className="flex flex-col items-center justify-center p-4 rounded-2xl active:scale-95 transition-all duration-300 relative overflow-hidden bg-white"
              style={{
            ...
            {/* Workers */}
            <button
              onClick={() => navigate('/sp/vendor/workers')}
              className="flex flex-col items-center justify-center p-4 rounded-2xl active:scale-95 transition-all duration-300 relative overflow-hidden bg-white"
              style={{
                boxShadow: '0 4px 12px rgba(0, 166, 166, 0.08), 0 2px 6px rgba(0, 0, 0, 0.05)',
                border: '1.5px solid rgba(0, 166, 166, 0.15)',
