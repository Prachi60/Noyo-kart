  ...
  useEffect(() => {
    const loadProfile = async () => {
      try {
        ...
        const localVendorData = JSON.parse(localStorage.getItem('spVendorData') || '{}');
        const vendorProfile = JSON.parse(localStorage.getItem('spVendorProfile') || '{}');

        // Merge sources, preferring spVendorData (which might be fresher from other pages)
        ...
        if (response.success) {
          ...
          localStorage.setItem('spVendorData', JSON.stringify(apiData));
          localStorage.setItem('spVendorProfile', JSON.stringify({ ...storedData, ...apiData }));
        }
    ...
    <div className="min-h-screen pb-20" style={{ background: themeColors.backgroundGradient }}>
      ...
      <main className="px-4 pt-4 pb-6">
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <button
            onClick={() => navigate('/sp/vendor/profile/edit')}
