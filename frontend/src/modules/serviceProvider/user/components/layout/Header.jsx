...
import { animateLogo } from '@sp/utils/gsapAnimations';
        ...
        <div className="w-full">
          ...
          <div className="px-4 py-3 flex items-center justify-between">
            ...
            <nav className="hidden lg:flex items-center gap-8 ml-10">
              <Link to="/sp/user" className="text-gray-700 font-semibold hover:text-[#347989] transition-colors">Home</Link>
              <Link to="/sp/user/my-bookings" className="text-gray-700 font-semibold hover:text-[#347989] transition-colors">Bookings</Link>
              <Link to="/sp/user/scrap" className="text-gray-700 font-semibold hover:text-[#347989] transition-colors">Scrap</Link>
              <Link to="/sp/user/cart" className="text-gray-700 font-semibold hover:text-[#347989] transition-colors">Cart</Link>
              <Link to="/sp/user/account" className="text-gray-700 font-semibold hover:text-[#347989] transition-colors">Account</Link>
            </nav>
