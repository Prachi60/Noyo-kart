...
import { configService } from '@sp/services/configService';
...
const Footer = () => {
  ...
  if (location.pathname !== '/sp/user' && location.pathname !== '/sp/user/') {
    return null;
  }
  ...
  const footerSections = [
    {
      title: 'Company',
      links: [
        { label: 'About Us', path: '/sp/user/about-homestr' },
        { label: 'Help & Support', path: '/sp/user/help-support' },
        { label: 'Cancellation Policy', path: '/sp/user/cancellation-policy' },
    ...
    },
    {
      title: 'Quick Links',
      links: [
        { label: 'My Bookings', path: '/sp/user/my-bookings' },
        { label: 'My Wallet', path: '/sp/user/wallet' },
        { label: 'My Plan', path: '/sp/user/my-plan' },
        { label: 'Register as Vendor', path: '/sp/vendor/signup' },
        { label: 'Register as Worker', path: '/sp/worker/signup' },
      ]
    },
    {
      title: 'Contact Us',
      links: [
        { 
          label: settings?.supportEmail || settings?.companyEmail || 'support@truliq.in', 
          path: `mailto:${settings?.supportEmail || settings?.companyEmail || 'support@truliq.in'}`, 
          icon: FiMail 
        },
        { 
      ...
      <div className="max-w-screen-xl mx-auto px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            <Link to="/sp/user" className="inline-block transform hover:scale-105 transition-transform duration-300">
