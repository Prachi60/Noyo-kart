...
const ACApplianceModal = React.memo(({ isOpen, onClose, location, cartCount }) => {
  ...
  const homeAppliances = [
    { id: 1, title: 'AC', icon: '❄️' },
    { id: 2, title: 'Washing Machine', icon: '🧺' },
    { id: 3, title: 'Geyser Repair', icon: '🚿' },
  ];

  const kitchenAppliances = [
    { id: 1, title: 'Water Purifier', icon: '🚰' },
    { id: 2, title: 'Refrigerator', icon: '🧊' },
    { id: 3, title: 'Microwave Repair', icon: '⏲️' },
  ];
