...
const Cart = () => {
  ...
  // Category icon mapping using react-icons for modern look and reliability
  const getCategoryIcon = (category) => {
    const iconMap = {
      'Electrician': <FiZap className="w-7 h-7 text-amber-500" />,
      'Electricity': <FiZap className="w-7 h-7 text-amber-500" />,
      "Women's Salon & Spa": <FiStar className="w-7 h-7 text-rose-500" />,
      'Salon for Women': <FiStar className="w-7 h-7 text-rose-500" />,
      'Salon Prime': <FiStar className="w-7 h-7 text-rose-500" />,
      'Massage for Men': <FiHeart className="w-7 h-7 text-blue-500" />,
      'Cleaning': <FiCheckSquare className="w-7 h-7 text-emerald-500" />,
      'Bathroom & Kitchen Cleaning': <FiCheckSquare className="w-7 h-7 text-emerald-500" />,
      'Sofa & Carpet Cleaning': <FiCheckSquare className="w-7 h-7 text-emerald-500" />,
      'AC Service and Repair': <FiWind className="w-7 h-7 text-cyan-500" />,
      'AC & Appliance Repair': <FiWind className="w-7 h-7 text-cyan-500" />,
    };
    return iconMap[category] || <FiShoppingCart className="w-7 h-7 text-teal-600" />;
  };
