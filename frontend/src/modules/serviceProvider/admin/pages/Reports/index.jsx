  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Link to="/sp/admin/reports/bookings" className="group">
        ...
        <Link to="/sp/admin/reports/vendors" className="group">
        ...
        <Link to="/sp/admin/reports/workers" className="group">
...
const Reports = () => {
  ...
  const navTabs = [
    { name: 'Overview', path: '/sp/admin/reports', icon: FiActivity, exact: true },
    { name: 'Revenue', path: '/sp/admin/reports/revenue', icon: FiDollarSign },
    { name: 'Bookings', path: '/sp/admin/reports/bookings', icon: FiShoppingBag },
    { name: 'Vendors', path: '/sp/admin/reports/vendors', icon: FiUsers },
    { name: 'Workers', path: '/sp/admin/reports/workers', icon: FiBriefcase },
  ];
