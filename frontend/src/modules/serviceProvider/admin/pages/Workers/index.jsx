...
const Workers = () => {
  ...
  const navTabs = [
    { name: 'All Workers', path: '/sp/admin/workers/all', icon: FiUsers },
    { name: 'Worker Jobs', path: '/sp/admin/workers/jobs', icon: FiClock },
    { name: 'Worker Analytics', path: '/sp/admin/workers/analytics', icon: FiActivity },
  ];
