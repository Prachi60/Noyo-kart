                                ...
                                <form onSubmit={handleTicketSubmit} className="space-y-6">
                                    <div className="space-y-2">
                                        ...
                                        <input
                                            ...
                                            className="w-full bg-slate-50 border-none rounded-2xl px-5 py-4 text-sm font-bold outline-none ring-1 ring-transparent focus:ring-[#0284c7]/20 transition-all"
                                        />
                                    </div>
                                            ...
                                            <button
                                                ...
                                                className={cn(
                                                    ...
                                                    ticketData.priority === p
                                                        ? "bg-[#0284c7] text-white border-[#0284c7] shadow-lg shadow-brand-100"
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <textarea
                                            ...
                                            className="w-full bg-slate-50 border-none rounded-2xl px-5 py-4 text-sm font-bold min-h-[150px] outline-none ring-1 ring-transparent focus:ring-[#0284c7]/20 transition-all"
                                        />
                                    </div>
                                    ...
                                    <Button
                                        ...
                                        className="w-full h-14 bg-[#0284c7] hover:bg-[#0b721b] text-white text-lg font-black rounded-2xl shadow-xl shadow-brand-100 transition-all active:scale-95"
                                    >
                                        {ticketLoading ? (
