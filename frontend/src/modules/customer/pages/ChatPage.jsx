                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-3">
                        <div className="relative">
                            <div className="h-10 w-10 bg-[#0284c7] rounded-full flex items-center justify-center text-white font-black text-sm shadow-sm ring-2 ring-white">
                                AS
                            </div>
            ...
            <div className="bg-white p-3 border-t border-slate-100 shrink-0 z-30 safe-area-bottom relative mb-4">
                ...
                <div className="flex items-end gap-2 bg-slate-50 p-2 rounded-[1.5rem] border border-slate-200 focus-within:border-cyan-300 focus-within:shadow-[0_0_0_4px_rgba(97,218,251,0.1)] transition-all">
                    <button
                        ...
                        className={`p-2.5 rounded-full hover:text-slate-600 hover:bg-slate-200 transition-colors flex-shrink-0 ${showEmojiPicker ? 'text-[#0284c7] bg-cyan-50' : 'text-slate-400'}`}
                    >
                        <Smile size={22} />
                    </button>
                    ...
                    <button
                        ...
                        className="p-2.5 rounded-full bg-[#0284c7] text-white hover:bg-[#38bdf8] transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-md shadow-cyan-200 flex-shrink-0"
                    >
