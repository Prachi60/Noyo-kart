      ...
      <div className="bg-white/70 backdrop-blur-xl border-b border-white/20 sticky top-0 z-50 shadow-[0_1px_20px_rgba(0,0,0,0.03)]">
        <div className="max-w-5xl mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <button
              onClick={handleBack}
              className="w-10 h-10 flex items-center justify-center bg-slate-50 hover:bg-slate-900 hover:text-white rounded-xl transition-all active:scale-95 group"
            >
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest flex items-center gap-1">
                  <ShieldCheck size={10} className="text-emerald-500" /> Secure Documents
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="max-w-5xl mx-auto p-4 pt-8">
        <AnimatePresence mode="wait">
            ...
            >
              ...
              >
                ...
                <div className="relative z-10 flex flex-col items-center">
                  <motion.div
                    ...
                    className="w-20 h-20 bg-white rounded-[24px] shadow-xl shadow-indigo-100 flex items-center justify-center text-slate-400 group-hover:bg-slate-900 group-hover:text-white transition-all duration-500 mb-6"
                  >
                    <CloudUpload size={40} />
                  </motion.div>
              ...
              <div className="flex flex-col gap-5">
                <Button
                  ...
                  className="w-full py-6 rounded-[32px] bg-slate-900 hover:bg-black text-white font-black tracking-widest text-xs flex items-center justify-center gap-4 group shadow-2xl shadow-slate-300 relative overflow-hidden"
                >
            ...
            >
              <div className="flex items-center justify-between mb-2 px-2">
                ...
                <Button 
                  variant="outline" 
                  onClick={() => setStep(1)}
                  className="bg-white border-slate-200 text-slate-600 rounded-2xl text-[10px] font-black tracking-widest py-3 px-6 hover:bg-slate-900 hover:text-white transition-all shadow-sm"
                >
                  ADD FILES
                </Button>
              </div>
                  ...
                  >
                    <Card className="p-8 border-none shadow-2xl shadow-slate-200/60 rounded-[40px] bg-white/90 backdrop-blur-sm relative overflow-hidden group">
                      ...
                      <div className="flex items-center gap-4 mb-8">
                        <div className="w-12 h-12 bg-slate-900 rounded-2xl flex items-center justify-center text-white shadow-xl shadow-indigo-100">
                          <FileText size={20} />
                        </div>
                        <div>
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="flex items-center gap-4 bg-slate-100/50 p-1.5 rounded-2xl">
                            <button 
                              ...
                              className="w-10 h-10 bg-white shadow-sm rounded-xl flex items-center justify-center text-slate-900 active:scale-90 transition-all font-black hover:bg-slate-900 hover:text-white hover:rotate-[-10deg]"
                            >
                              -
                            </button>
              ...
              <div className="pt-8 sticky bottom-4">
                <Button 
                  onClick={() => setStep(3)}
                  className="w-full py-6 rounded-[32px] bg-slate-900 text-white font-black tracking-widest text-xs flex items-center justify-between group shadow-[0_20px_50px_rgba(0,0,0,0.2)]"
                >
          ...
          {step === 3 && (
            ...
            >
              <div className="flex items-center gap-4 mb-8">
                <div className="h-14 w-1 flex bg-slate-900 rounded-full" />
                <div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div className="lg:col-span-2 space-y-6">
                  ...
                  {/* Nearest Seller Info */}
                  {quote && quote.seller && (
                    <div className="bg-linear-to-br from-slate-900 to-black p-8 rounded-[40px] text-white shadow-2xl relative overflow-hidden group">
                        ...
                        <div className="text-center py-6">
                          ...
                          <div className="space-y-3">
                            <Button 
                              onClick={() => navigate("/")}
                              variant="outline"
                              className="w-full py-3.5 rounded-xl border-slate-200 text-slate-600 font-black tracking-widest text-[10px] hover:bg-slate-900 hover:text-white transition-all"
                            >
                              BACK TO HOME
                            </Button>
                            <Button 
                              onClick={() => setStep(1)}
                              className="w-full py-3.5 rounded-xl bg-slate-900 text-white font-black tracking-widest text-[10px] shadow-lg shadow-slate-200"
                            >
                              MODIFY FILES
                            </Button>
                          </div>
