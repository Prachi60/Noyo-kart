...
const OffersPage = () => {
  ...
  return (
    <div className="relative z-10 py-8 w-full max-w-[1920px] mx-auto px-4 md:px-[50px] mt-36 md:mt-24">
      ...
      >
        <h1 className="text-3xl md:text-5xl font-black tracking-tight text-[#61dafbaa] mb-3">
          Best Offers for You
        </h1>
              ...
              >
                ...
                >
                  ...
                  <div className="flex items-center justify-between mt-auto">
                    ...
                    <button className="h-12 w-12 bg-white rounded-full flex items-center justify-center text-[#61dafbaa] transform transition-transform group-hover:rotate-[-45deg]">
                      <ArrowRight size={24} />
                    </button>
                  </div>
                </div>
