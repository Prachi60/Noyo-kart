    ...
    return (
      <div className="relative w-full min-h-[260px] bg-gradient-to-br from-[#f0faf4] to-[#e8f5e9] overflow-hidden rounded-b-[2rem] flex flex-col items-center justify-center gap-3 px-6 py-10 border-b border-brand-100">
        <motion.div
          ...
          className="h-16 w-16 bg-[#0284c7] rounded-full flex items-center justify-center shadow-lg shadow-brand-200">
    ...
    return (
      <div className="relative w-full h-[320px] bg-gradient-to-br from-[#f0faf4] to-[#e8f5e9] overflow-hidden rounded-b-[2rem] flex flex-col items-center justify-center gap-4">
        ...
        {[1, 2, 3].map((i) => (
          <motion.div
            key={i}
            className="absolute rounded-full border-2 border-[#0284c7]/20"
        ...
        <motion.div
          ...
          className="relative z-10 h-16 w-16 bg-[#0284c7] rounded-full flex items-center justify-center shadow-xl shadow-brand-200">
    ...
    <div className="relative w-full h-[350px] bg-[#E5E3DF] overflow-hidden rounded-b-[2rem] shadow-md border-b border-gray-200">
      ...
      <div className="absolute top-4 left-4 right-4 z-40 flex justify-between items-start">
        <motion.div
          ...
          <div className="h-10 w-10 bg-brand-50 rounded-xl flex items-center justify-center text-[#0284c7]">
          ...
          <motion.div
            ...
            <div className="flex items-center gap-3">
              <div className="relative">
                ...
                <div className="absolute -bottom-0.5 -right-0.5 bg-[#0284c7] text-white text-[7px] font-bold px-1 py-0.5 rounded-full flex items-center gap-0.5">
              ...
              <div className="flex items-center gap-1.5">
                <button className="h-8 w-8 rounded-full bg-brand-50 flex items-center justify-center text-[#0284c7] hover:bg-brand-100 transition-colors">
                  <Phone size={14} />
                </button>
