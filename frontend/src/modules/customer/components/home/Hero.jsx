...
const Hero = () => {
    ...
    return (
        <section className="relative w-full overflow-hidden bg-[#0284c7] pt-12 pb-12 md:pb-24 lg:pt-16">
                            ...
                            >
                                ...
                                <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent p-6 md:p-12 flex flex-col justify-end text-white">
                                    <div className={`transform transition-all duration-700 ${index === current ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
                                        ...
                                        <Button className="bg-white text-[#0284c7] hover:bg-[#ecfeff] hover:scale-105 active:scale-95 font-bold px-6 py-5 md:px-8 md:py-7 rounded-xl md:rounded-2xl text-sm md:text-lg shadow-[0_8px_30px_rgb(0,0,0,0.12)] transition-all w-auto">
