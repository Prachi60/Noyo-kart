      ...
      <motion.div
        ...
        <div className={cn("relative pb-0", compact ? "p-1.5" : "p-2.5")}>
          ...
          {(badge ||
            ...
            product.originalPrice > product.price) && (
              <div
                className={cn(
                  "absolute z-10 bg-[#0284c7] text-white font-[900] rounded-md shadow-sm uppercase tracking-wider flex items-center justify-center",
                  compact
        ...
        <div
          ...
          <div className="flex items-center gap-1.5 mb-1">
            <div
              className={cn(
                "border-2 border-[#0284c7] rounded-full flex items-center justify-center",
                compact ? "h-2.5 w-2.5" : "h-3.5 w-3.5",
              )}>
              <div
                className={cn(
                  "bg-[#0284c7] rounded-full",
          ...
          <div className="flex items-center gap-1.5 text-gray-500 mt-1 mb-2">
            <Clock size={compact ? 10 : 11} className="text-[#0284c7]/80" />
            <span
              className={cn(
                "font-semibold",
          ...
          <div className="mt-auto flex items-center justify-between gap-1.5">
            ...
            <div className="flex">
              {quantity > 0 ? (
                <div
                  className={cn(
                    "flex items-center bg-white border-[1.5px] border-[#0284c7] rounded-lg p-0.5 justify-between",
                    compact ? "min-w-[64px]" : "min-w-[90px] md:min-w-[100px]",
                  )}>
                  <button
                    onClick={handleDecrement}
                    className="p-1 px-1 text-[#0284c7] active:scale-90 transition-transform">
                ...
                <motion.button
                  ...
                  className={cn(
                    "bg-white border-[1.5px] border-[#0284c7] text-[#0284c7] rounded-lg font-black shadow-sm hover:bg-[#0284c7]/5 mb-0 transition-all uppercase tracking-wide leading-none",
                    compact
