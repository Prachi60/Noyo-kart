...
const SlideToPay = ({
    ...
    return (
        <div
            className="relative h-16 w-full rounded-full overflow-hidden select-none touch-none bg-linear-to-r from-[#0284c7] via-[#0284c7] to-[#0284c7] shadow-[0_18px_45px_rgba(4,120,87,0.35)] border border-white/10"
            ...
            >
                {isLoading || isCompleted ? (
                    ...
                    <motion.div
                        ...
                        style={{ rotate }}
                    >
                        <motion.div className="text-[#0284c7]" style={{ opacity: arrowsOpacity }}>
