                ...
                >
                    <div className="flex items-center gap-3">
                        <div className={cn(
                            ...
                            isOpen ? "bg-cyan-50 text-[#0284c7]" : "bg-slate-50 text-slate-400 group-hover:bg-slate-100"
                        )}>
                            {icon}
                        </div>
                        <span className={cn(
                    ...
                    <motion.div
                        ...
                        className={cn("transition-colors", isOpen ? "text-[#0284c7]" : "text-slate-300")}
                    >
                ...
                <>
                                    ...
                                    <div className="absolute top-0 left-0 right-0 flex items-center justify-between p-5 z-20">
                                        ...
                                        {(selectedProduct.originalPrice > selectedProduct.price) && (
                                            <motion.div
                                                ...
                                                className="bg-gradient-to-r from-[#0284c7] to-[#38bdf8] text-white text-[10px] font-[800] px-3 py-1.5 rounded-xl uppercase tracking-wider shadow-md shadow-cyan-200/40"
                                            >
                                                ...
                                                {allImages.slice(0, 5).map((img, i) => (
                                                    <motion.button
                                                        ...
                                                        className={cn(
                                                            ...
                                                            i === activeImageIndex
                                                                ? 'border-[#0284c7] shadow-lg shadow-cyan-100/60 ring-2 ring-cyan-100 bg-white'
                                            ...
                                            {allImages.map((_, i) => (
                                                <button
                                                    ...
                                                    className={cn(
                                                        ...
                                                        i === activeImageIndex ? 'w-8 h-2 bg-[#0284c7]' : 'w-2 h-2 bg-gray-300/60 hover:bg-gray-400'
                                                    )}
                                                />
                                            ))}
                                        </div>
                                    ...
                                    <div className="flex-1 px-7 py-6 lg:px-8 lg:py-7 space-y-3">
                                        ...
                                        <div className="flex items-center gap-2 flex-wrap">
                                            <motion.div
                                                ...
                                                className="inline-flex items-center gap-1.5 bg-[#ecfeff] border border-cyan-200/50 text-[#0284c7] px-3 py-1.5 rounded-lg text-[10px] font-[700] uppercase tracking-wider"
                                            >
                                                <Clock size={12} strokeWidth={2.5} className="text-[#0284c7]" />
                                            ...
                                            {selectedProduct.originalPrice > selectedProduct.price && (
                                                <motion.div
                                                    ...
                                                    className="text-[10px] font-[700] text-[#0284c7] bg-cyan-50 px-3 py-1.5 rounded-lg border border-cyan-200/50 uppercase tracking-wider"
                                                >
                                            ...
                                            <div className="relative flex items-center justify-between py-4 px-5">
                                                <div className="flex flex-col gap-1">
                                                    <div className="flex items-baseline gap-2">
                                                        <span className="text-[28px] lg:text-[32px] font-[800] text-[#0284c7] tracking-tight leading-none">
                                                ...
                                                <div>
                                                    {quantity > 0 ? (
                                                        <div className="flex items-center gap-1 bg-white border border-cyan-200 rounded-xl p-1 shadow-sm">
                                                            ...
                                                            <motion.button whileTap={{ scale: 0.85 }} onClick={handleIncrement} className="w-9 h-9 bg-[#0284c7] rounded-lg flex items-center justify-center text-white hover:bg-[#38bdf8] transition-colors shadow-sm">
                                                    ...
                                                    <motion.button
                                                        ...
                                                        className="bg-gradient-to-r from-[#0284c7] to-[#38bdf8] text-white h-12 px-8 rounded-xl font-black text-[13px] flex items-center gap-2 shadow-lg shadow-cyan-100 hover:shadow-cyan-200 transition-all uppercase tracking-widest border border-white/20"
                                                    >
                                        ...
                                        {cartCount > 0 && (
                                            ...
                                            >
                                                <Link
                                                    to="/checkout"
                                                    onClick={closeProduct}
                                                    className="w-[80%] bg-gradient-to-r from-[#0284c7] to-[#0ea5e9] text-white h-[40px] rounded-xl flex items-center justify-between px-4 shadow-md shadow-cyan-200/40 hover:shadow-lg hover:-translate-y-0.5 transition-all active:scale-[0.98]"
                                                >
                                                        ...
                                                        <motion.button
                                                            ...
                                                            className={cn(
                                                                ...
                                                                selectedVariant?.sku === v.sku
                                                                    ? 'bg-brand-50 border-[#0284c7] text-[#0284c7] shadow-md shadow-brand-100/50'
                                                    ...
                                                    {selectedProduct.variants.map((v, idx) => (
                                                        <motion.button
                                                            ...
                                                            className={cn(
                                                                ...
                                                                selectedVariant?.sku === v.sku
                                                                    ? 'bg-white border-[#0284c7] text-[#0284c7] shadow-sm shadow-cyan-100'
                                            ...
                                            >
                                                <div className="space-y-6 mt-2">
                                                    <div className="flex items-center justify-between mb-4">
                                                        <div className="flex items-center gap-1.5 px-3 py-1.5 bg-cyan-50 text-[#0284c7] rounded-xl text-xs font-black border border-cyan-100">
                                                    ...
                                                    <div className="bg-slate-50 p-4 rounded-2xl border border-slate-100 mb-6">
                                                        ...
                                                        <form onSubmit={handleReviewSubmit} className="space-y-3">
                                                                ...
                                                                {[1, 2, 3, 4, 5].map((s) => (
                                                                    <motion.button
                                                                        ...
                                                                        className={cn(
                                                                            ...
                                                                            newReview.rating >= s ? 'bg-cyan-50 text-[#0284c7] border border-cyan-100' : 'bg-white text-slate-300 border border-slate-100'
                                                                        )}
                                                                    >
                                                            ...
                                                            <textarea value={newReview.comment} onChange={(e) => setNewReview({ ...newReview, comment: e.target.value })} placeholder="Share your experience..." className="w-full bg-white border border-slate-100 rounded-xl p-3 text-xs font-medium min-h-[80px] outline-none focus:border-[#0284c7] transition-all resize-none shadow-sm" />
                                                            <Button type="submit" disabled={isSubmittingReview} className="w-full h-10 bg-[#0284c7] hover:opacity-90 text-white font-black rounded-xl text-[11px] uppercase tracking-[0.1em] transition-all shadow-lg shadow-cyan-100">
                                                    ...
                                                    <div className="space-y-3">
                                                        {reviewLoading ? (
                                                            <div className="flex justify-center py-6"><Loader2 className="animate-spin text-[#0284c7]" size={20} /></div>
                                                        ) : reviews.length > 0 ? (
                                                            reviews.map((r, rIdx) => (
                                                                <div key={r._id} className="p-4 rounded-xl border border-slate-100 bg-white hover:shadow-md hover:translate-x-1 transition-all group">
                                                                    <div className="flex justify-between items-start mb-2">
                                                                        <div className="flex items-center gap-2">
                                                                            <div className="h-8 w-8 rounded-full bg-cyan-50 flex items-center justify-center text-[11px] font-black text-[#0284c7] border border-cyan-100">{r.userId?.name?.[0] || 'A'}</div>
                                                                            <div>
                                                                                <p className="text-[12px] font-black text-slate-800">{r.userId?.name || 'Anonymous'}</p>
                                                                                <div className="flex gap-0.5">{[...Array(5)].map((_, i) => <Star key={i} size={9} className={cn(i < r.rating ? 'text-[#0284c7] fill-[#0284c7]' : 'text-slate-200')} />)}</div>
                                                                            </div>
                                                                        </div>
                    ...
                    >
                        ...
                        <div className="absolute top-0 left-0 right-0 p-4 flex justify-between items-center z-40 pointer-events-none">
                            ...
                            >
                                <ArrowLeft size={24} className="text-[#0284c7]" strokeWidth={3} />
                            </motion.button>
                        ...
                        >
                                        ...
                                        {allImages.map((_, i) => (
                                            <div
                                                ...
                                                className={cn(
                                                    ...
                                                    i === activeImageIndex ? "w-6 bg-[#0284c7]" : "w-1.5 bg-gray-300"
                                                )}
                                            />
                                        ))}
                                    </div>
                            ...
                            <div className="px-5 pt-2 pb-6">
                                {/* Delivery Time Badge */}
                                <div className="inline-flex items-center gap-1.5 bg-[#F0FDF4] border border-brand-100 text-[#0284c7] px-2.5 py-1 rounded-lg text-[10px] font-black uppercase mb-3">
                                            ...
                                            {selectedProduct.variants.map((v, idx) => (
                                                <motion.button
                                                    ...
                                                    className={cn(
                                                        ...
                                                        selectedVariant?.sku === v.sku
                                                            ? "bg-[#ecfeff] border-[#0284c7] text-[#0284c7] shadow-sm shadow-cyan-100"
                                                            : "bg-slate-50 border-slate-100 text-slate-500"
                                                    )}
                                                >
                                                    {v.name}
                                                    {selectedVariant?.sku === v.sku && (
                                                        <div className="absolute top-0 right-0 w-3 h-3 bg-[#0284c7] rounded-bl-lg" />
                                                    )}
                                                </motion.button>
                                            ))}
                                        </div>
                                        ...
                                        <div className="space-y-6 mt-2">
                                            ...
                                            <div className="bg-slate-50 p-5 rounded-3xl border border-slate-100 mb-6">
                                                ...
                                                <form onSubmit={handleReviewSubmit} className="space-y-4">
                                                    ...
                                                    <textarea value={newReview.comment} onChange={(e) => setNewReview({ ...newReview, comment: e.target.value })} placeholder="Write your experience..." className="w-full bg-white border border-slate-100 rounded-2xl p-4 text-sm font-medium min-h-[100px] outline-none focus:border-[#0284c7] transition-all resize-none shadow-sm" />
                                                    <Button type="submit" disabled={isSubmittingReview} className="w-full h-12 bg-[#0284c7] hover:opacity-90 text-white font-black rounded-xl text-xs uppercase tracking-widest transition-all shadow-lg shadow-cyan-100">
                                                        {isSubmittingReview ? "Submitting..." : "Post Review"}
                                                    </Button>
                                                </form>
                                            </div>
                                            ...
                                            <div className="space-y-4">
                                                {reviewLoading ? (
                                                    <div className="flex justify-center py-8"><Loader2 className="animate-spin text-[#0284c7]" size={24} /></div>
                                                ) : reviews.length > 0 ? (
                                                    reviews.map((r, rIdx) => (
                                                        <div key={r._id} className="p-5 rounded-2xl border border-slate-100 bg-white hover:shadow-md transition-all">
                                                            <div className="flex justify-between items-start mb-2">
                                                                <div className="flex items-center gap-2">
                                                                    <div className="h-8 w-8 rounded-full bg-cyan-50 flex items-center justify-center text-[10px] font-black text-[#0284c7] border border-cyan-100">{r.userId?.name?.[0] || 'A'}</div>
                                                                    <div>
                                                                        <p className="text-xs font-black text-slate-800">{r.userId?.name || 'Anonymous'}</p>
                                                                        <div className="flex gap-0.5">{[...Array(5)].map((_, i) => <Star key={i} size={10} className={cn(i < r.rating ? 'text-[#0284c7] fill-[#0284c7]' : 'text-slate-200')} />)}</div>
                                                                    </div>
                                                                </div>
                                                                <span className="text-[10px] font-bold text-slate-400">{new Date(r.createdAt).toLocaleDateString()}</span>
                                                            </div>
                                    ...
                                    {quantity > 0 ? (
                                        <div className="flex items-center gap-1 bg-slate-50 border-2 border-slate-100 rounded-2xl p-1.5 shadow-inner flex-1 justify-between max-w-[170px]">
                                            ...
                                            <motion.button
                                                ...
                                                className="w-10 h-10 bg-gradient-to-br from-[#0284c7] to-[#38bdf8] rounded-xl flex items-center justify-center text-white shadow-lg shadow-cyan-100/50 hover:shadow-cyan-200 transition-all border border-white/20"
                                            >
                                        ...
                                        <motion.button
                                            ...
                                            whileTap={{ scale: 0.95 }}
                                            onClick={handleAddToCart}
                                            className="flex-1 bg-gradient-to-r from-[#0284c7] to-[#38bdf8] text-white h-[56px] rounded-2xl font-black text-sm flex items-center justify-center gap-2 shadow-xl shadow-cyan-100 transition-all border border-white/20 uppercase tracking-[0.05em] whitespace-nowrap px-4"
                                        >
                                ...
                                {cartCount > 0 && (
                                    ...
                                    >
                                        <Link
                                            to="/checkout"
                                            onClick={closeProduct}
                                            className="w-full bg-gradient-to-r from-[#0284c7] to-[#33c9f2] text-white h-[64px] rounded-2xl flex items-center justify-between px-5 shadow-xl shadow-cyan-200/50 hover:shadow-cyan-300 transition-all active:scale-[0.98] border border-white/20 relative overflow-hidden group"
                                        >
