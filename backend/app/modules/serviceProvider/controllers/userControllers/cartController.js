...
const getCart = async (req, res) => {
  try {
    ...
    let cart = await SpCart.findOne({ userId }).populate('items.serviceId', 'title iconUrl basePrice discountPrice');
  ...
  try {
    ...
    if (existingItemIndex > -1) {
      ...
      cart.items.push({
        ...
        brandId: brandId || sectionId || null,
        title,
